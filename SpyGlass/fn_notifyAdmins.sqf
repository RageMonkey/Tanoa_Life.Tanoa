...
systemChat format["SPY-GLASS Cheater Flagged - Name: %1<br/>Detection: %2",_pName,_pReason];
...
diag_log format["SPY-GLASS Cheater Flagged - Name: %1<br/>Detection: %2",_pName,_pReason];