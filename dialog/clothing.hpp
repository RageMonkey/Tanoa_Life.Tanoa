class Life_Clothing {
	...
	class controls 
	{
		...
		class ClothingList : Life_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[_this] call life_fnc_changeClothes; [] call life_fnc_equipGear;";
		...
		class CloseButtonKey : Life_RscButtonMenu 
		{
			...
			onButtonClick = "closeDialog 0; [] call life_fnc_equipGear;";
		...
		class BuyButtonKey : Life_RscButtonMenu 
		{
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call life_fnc_buyClothes; [] call life_fnc_equipGear;";
			x = (1 / 250 / (safezoneW / safezoneH));
			y = 0.54 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
