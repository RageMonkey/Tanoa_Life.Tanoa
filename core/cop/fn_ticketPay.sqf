...
if(life_RoT_money < life_ticket_val) exitWith
{
	if(life_RoT_atm < life_ticket_val) exitWith 
	{
	...
	life_RoT_atm = life_RoT_atm - life_ticket_val;
...
life_RoT_money = life_RoT_money - life_ticket_val;
life_ticket_paid = true;
