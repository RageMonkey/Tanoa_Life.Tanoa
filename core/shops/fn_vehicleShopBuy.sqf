...
if(life_RoT_money < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_RoT_money] call life_fnc_numberText];};
...
life_RoT_money = life_RoT_money - _basePrice;
