...
*/
private["_target","_revivable","_targetName","_ui","_progressBar","_titleText","_cP","_title","_times","_anim"];
...
if(_target getVariable ["killConfirmed",FALSE]) exitWith {hint localize "STR_Medic_PlayerDead";};
...
//Removed because players were killing themselves
