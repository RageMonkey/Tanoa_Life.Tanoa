...
switch (_vehicle) do
{
	...
	case "O_Heli_Transport_04_F" :
	{
		switch (_index) do
		{
			case 0: {_color = "Rebel";};
			case 1: {_color = "Rebel";};
			case 2: {_color = "Salvage";};
			case 3: {_color = "Salvage";};
		};
	};
	...
	case "C_Offroad_01_F" :
	{
		switch (_index) do
		{
			...
			case 7: {_color = "Taxi"};
			case 8: {_color = "Cop"}; 
			case 9: {_color = "Rally Green"}; //Black & Green Rally
			case 10: {_color = "Rally Red"}; //Ferrari
		};
	};
	...
	case "C_Hatchback_01_sport_F":
	{
		switch(_index) do
		{
			...
			case 8: {_color = "Rally Munster"};
			case 9: {_color = "Rally V"};
		};
	};
	...
	case "O_MRAP_02_F":
	{
		switch (_index) do
		{
			case 0: {_color = "Rebel Camo Brown"};
			case 1: {_color = "Rebel Camo Green"};
	...
	case "I_Heli_Transport_02_F":
	{
		switch (_index) do
		{
			...
			case 2: {_color = "Rebel Camo Green"};
	...
	case "C_Heli_Light_01_civil_F":
	{
		switch (_index) do
		{
			...
			case 2: {_color = "Furious"};
			case 3: {_color = "Gray Watcher"};
			case 4: {_color = "Jeans"};
			case 5: {_color = "Light"};
			case 6: {_color = "Shadow"};
			case 7: {_color = "Sheriff"};
			case 8: {_color = "Speedy"};
			case 9: {_color = "Wasp"};
			case 10: {_color = "Wave"};
			case 11: {_color = "Elliptical"};
