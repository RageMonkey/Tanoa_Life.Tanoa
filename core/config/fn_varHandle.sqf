...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "prayer": {"life_inv_prayer"};
            case "bdiamond": {"life_inv_bdiamond"};
			case "bdiamondc": {"life_inv_bdiamondc"};
			case "pills": {"life_inv_pills"};
			case "panadol": {"life_inv_panadol"};
			case "ecstasy": {"life_inv_ecstasy"};
			case "paracetamol": {"life_inv_paracetamol"};
			case "chemicals": {"life_inv_chemicals"};
			case "petrol": {"life_inv_petrol"};
			case "petrolp": {"life_inv_petrolp"};
			case "alienhead": {"life_inv_alienhead"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_prayer": {"prayer"};
            case "life_inv_bdiamond": {"bdiamond"};
			case "life_inv_bdiamondc": {"bdiamondc"};
			case "life_inv_pills": {"pills"};
			...
			case "life_inv_petrol": {"petrol"};
			case "life_inv_petrolp": {"petrolp"};
			case "life_inv_alienhead": {"alienhead"};
		};
	};
};
