...
if(playerSide == west) then {
	...
	//Helicopter DLC - Huron/Taru Pilot
	if(typeOf (_curTarget) in ["O_Heli_Transport_04_bench_F","O_Heli_Transport_04_F","B_Heli_Transport_03_unarmed_F"]) then {
		_Btn7 ctrlSetText localize "STR_vInAct_GetInHeli_Pilot";
	...
	//Helicopter DLC - Taru Loader
	if(typeOf (_curTarget) in ["O_Heli_Transport_04_bench_F","O_Heli_Transport_04_F"]) then {
		_Btn8 ctrlSetText localize "STR_vInAct_GetInHeli_Loader";
	...
	if(_curTarget isKindOf "Ship") then {
		...
		//Go Kart DLC
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F","B_Heli_Transport_03_unarmed_F"]) then {
	...
	//Helicopter DLC - Huron/Taru Pilot
	if(typeOf (_curTarget) in ["O_Heli_Transport_04_bench_F","O_Heli_Transport_04_F","B_Heli_Transport_03_unarmed_F"]) then {
		_Btn4 ctrlSetText localize "STR_vInAct_GetInHeli_Pilot";
	...
	//Helicopter DLC - Taru Loader
	if(typeOf (_curTarget) in ["O_Heli_Transport_04_bench_F","O_Heli_Transport_04_F"]) then {
		_Btn5 ctrlSetText localize "STR_vInAct_GetInHeli_Loader";
		_Btn5 buttonSetAction "player moveInGunner life_vInact_curTarget; closeDialog 0;";
