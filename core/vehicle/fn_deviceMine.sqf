...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","grape_1","rye_1","hops_1","yeast_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["fallout_zone_1"]): {"uranium"};
	case (_zone in ["bdiamond_1"]): {"bdiamond"};
	case (_zone in ["oil_rig_1","oil_rig_2"]): {"petrol"};
	default {""};
};
