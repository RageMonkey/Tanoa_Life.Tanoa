...
if(parseNumber(_amount) > life_RoT_money) exitWith {hint "You don't have that much to give!";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
...
life_RoT_money = life_RoT_money - (parseNumber(_amount));
