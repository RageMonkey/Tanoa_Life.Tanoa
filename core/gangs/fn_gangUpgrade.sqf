...
if(_action) then {
	if(life_RoT_atm < _upgradePrice) exitWith {
		hint parseText format[
			...
			[life_RoT_atm] call life_fnc_numberText,
			[_upgradePrice - life_RoT_atm] call life_fnc_numberText
		];
	};
	__SUB__(life_RoT_atm,_upgradePrice);
