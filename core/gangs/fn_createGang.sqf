...
if(life_RoT_atm < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-life_RoT_atm)] call life_fnc_numberText];};
